...
# ------------ default parameters -------------
DEFAULTS = {
    "coilcalibration": 66.37,        # uT / V  – coil B1 field per volt
    ...
    "ao_channel": "ao0",             # Analog output channel
    "B1_decouple": 20,              # uT       – CW 19F decoupling amplitude
    "f_decouple": 4700.0,           # Hz       – 19F Larmor / decoupling frequency
}
...
class SLICSequenceControl(tk.Toplevel):
    ...
    def build_waveform(self):
        ...
        # Add 19F decoupling across entire waveform
        v_decouple = (p["B1_decouple"] / coilcal)
        phase_decouple = 2 * np.pi * p["f_decouple"] * t
        wf += v_decouple * np.sin(phase_decouple)
        ...
        meta = {
            ...
            "f_decouple":        p["f_decouple"],
            "B1_decouple":       p["B1_decouple"],
            "voltage_range": {
